...
const CreateGroupModal = ({ onClose, onCreateGroup }) => {
  ...
  const handleCreateGroup = () => {
    ...
    onCreateGroup(groupName, JSON.stringify (userIds));
  };
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
        ...
        <div className="max-h-40 overflow-y-auto mb-4">
          {searchResults.map(user => (
            <div key={user._id} className="flex items-center p-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleSelectUser(user)}>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {selectedUsers.map(user => (
            <span key={user._id} className="flex items-center bg-gray-200 px-3 py-1 rounded-full">
        ...
        <div className="flex justify-end">
          <button className="bg-blue-500 text-white px-4 py-2 rounded mr-2" onClick={handleCreateGroup}>Create Group</button>
